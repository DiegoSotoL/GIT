 ...
 * @author diego
 */
public class MenuPacienteSala extends javax.swing.JFrame {

    /**
     * Creates new form MenuPacienteSala
     */
    public MenuPacienteSala() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("MANEJO DE PACIENTES");
        ...
        jButton2.setText("MANEJO DE SALAS");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPacienteSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPacienteSala().setVisible(true);
            }
        });
    }
