...
public class EliminarDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESE EL RUT DEL DOCTOR A ELIMINAR");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(80, 80, 80)
                        .addComponent(rut, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(105, 105, 105)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (MenuPrincipal.SH.getCiudades().getCiudad(cod).getHospitales().getHospital(codHospital).getDoctores().eliminarDoctor(rut.getText())) {
             
        Connection cn = Conectar.getConnection();
        PreparedStatement ps;
        
        String sql = "DELETE FROM doctor WHERE rut = '"+rut.getText()+"' ";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "ERROR AL ELIMINAR DOCTOR EN BD" + e);
        }
            JOptionPane.showMessageDialog(null, "Doctor eliminado correctamente");
        } else {
            JOptionPane.showMessageDialog(null, "RUT no existe, intente denuevo");
        }
