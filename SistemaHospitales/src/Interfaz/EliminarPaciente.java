...
public class EliminarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESE EL RUT DEL PACIENTE A ELIMINAR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (MenuPrincipal.SH.getCiudades().getCiudad(cod).getHospitales().getHospital(codHospital).getPacientes().eliminarCPaciente(rut.getText())) {
           
        Connection cn = Conectar.getConnection();
        PreparedStatement ps;
        
        String sql = "DELETE FROM paciente WHERE rut = '"+rut.getText()+"' ";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "ERROR AL ELIMINAR PACIENTE EN BD" + e);
        }
