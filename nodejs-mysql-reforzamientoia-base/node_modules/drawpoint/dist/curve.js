...
exports.continueCurve = exports.reverseDrawPoint = exports.transformCurve = exports.getCubicControlPoints = exports.elevateDegree = exports.simpleQuadratic = exports.interpolateCurve = exports.splitCurve = exports.getPointOnLine = exports.getPointOnCurve = exports.applyToCurve = void 0;
var point_1 = require("./point");
var util_1 = require("./util");
var numeric_1 = require("./numeric");
function applyToCurve(p1, p2, _a) {
    var linear = _a.linear, quadratic = _a.quadratic, cubic = _a.cubic;
    var ep1 = point_1.extractPoint(p1);
    var ep2 = point_1.extractPoint(p2);
    if (p2.cp1 && p2.cp2) {
...
function getPointOnCurve(t, p1, p2) {
    return applyToCurve(p1, p2, {
        linear: function () {
            ...
            return getPointOnLine.apply(void 0, __spreadArrays([t], cps));
        },
        quadratic: function () {
            var cps = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return point_1.makePoint.apply(void 0, __spreadArrays([getQuadraticValue.bind(null, t)], cps));
        },
        cubic: function () {
            var cps = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return point_1.makePoint.apply(void 0, __spreadArrays([getCubicValue.bind(null, t)], cps));
        },
    });
}
...
function getPointOnLine(t, p1, p2) {
    return point_1.makePoint(getLinearValue.bind(null, t), p1, p2);
}
...
function solveCubicEquation(a, b, c) {
    ...
    var discriminant = numeric_1.roundToDec(q2 * q2 + p3 * p3 * p3, 8);
    // 1 real root
    if (discriminant > 0) {
...
function interpolateCubic(p1, cp1, cp2, p2, p) {
    ...
    var c = p1 / d;
    // @ts-ignore
    return solveCubicEquation(a, b, c).map(function (t) { return numeric_1.roundToDec(t, 4); });
}
// noinspection JSUnusedGlobalSymbols
/**
...
function interpolateCurve(p1, p2, betweenPoint) {
    ...
    var ts = applyToCurve(p1, p2, {
        ...
        linear: function () {
            ...
            return interpolateLinear.apply(void 0, __spreadArrays(cps.map(function (cp) { return cp[knownDim]; }), [betweenPoint[knownDim]]));
        },
        // @ts-ignore
        quadratic: function () {
            var cps = [];
            ...
            return interpolateQuadratic.apply(void 0, __spreadArrays(cps.map(function (cp) { return cp[knownDim]; }), [betweenPoint[knownDim]]));
        },
        // @ts-ignore
        cubic: function () {
            var cps = [];
            ...
            return interpolateCubic.apply(void 0, __spreadArrays(cps.map(function (cp) { return cp[knownDim]; }), [betweenPoint[knownDim]]));
        },
    }).filter(function (t) {
        // solving cubic equations is not very numerically stable...
        t = numeric_1.roundToDec(t, 3);
        return t >= 0 && t <= 1;
    });
 ...
 */
function simpleQuadratic(p1, p2, t, deflection) {
    if (t === void 0) { t = 0.5; }
    if (deflection === void 0) { deflection = 0; }
    var cp1 = getPointOnLine(t, p1, p2);
    return point_1.add(cp1, point_1.getPerpendicularVector(point_1.diff(p1, p2)), deflection);
}
...
function elevateDegree(p1, p2) {
    ...
    cps.push(point_1.extractPoint(p2));
    var newEndPoint = point_1.extractPoint(p2);
    var _loop_1 = function (i, newDegree) {
        var coefficient = i / newDegree;
        newEndPoint["cp" + i] = point_1.makePoint(function (cpsPrev, cps) {
...
function getCubicControlPoints(p1, p2) {
    return applyToCurve(p1, p2, {
        ...
        cubic: function () { return [p2.cp1, p2.cp2]; }
    });
}
...
function transformCurve(t, p1, initP2, endP2) {
    ...
    var _a = getCubicControlPoints(p1, initP2), initCp1 = _a[0], initCp2 = _a[1];
    var _b = getCubicControlPoints(p1, endP2), endCp1 = _b[0], endCp2 = _b[1];
...
function reverseDrawPoint(start, end) {
    ...
    return {
        x: start.x,
        y: start.y,
        cp1: util_1.clone(end.cp2),
        cp2: util_1.clone(end.cp1)
    };
}
 ...
 */
function continueCurve(p1, p2, scaleBy) {
    if (scaleBy === void 0) { scaleBy = 1; }
    return applyToCurve(p1, p2, {
        linear: function () {
            return point_1.add(p2, point_1.diff(p1, p2), scaleBy);
        },
        quadratic: function () {
            var cubicEndPoint = elevateDegree(p1, p2);
            return point_1.scale(cubicEndPoint.cp2, -scaleBy, p2);
        },
        cubic: function () {
            return point_1.scale(p2.cp2, -scaleBy, p2);
        }
    });
}
exports.continueCurve = continueCurve;
