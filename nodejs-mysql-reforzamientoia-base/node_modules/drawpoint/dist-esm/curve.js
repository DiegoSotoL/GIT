...
export function applyToCurve(p1, p2, _a) {
    var linear = _a.linear, quadratic = _a.quadratic, cubic = _a.cubic;
    var ep1 = extractPoint(p1);
    var ep2 = extractPoint(p2);
    if (p2.cp1 && p2.cp2) {
...
export function getPointOnCurve(t, p1, p2) {
    return applyToCurve(p1, p2, {
        ...
        quadratic: function () {
            ...
            return makePoint.apply(void 0, __spreadArrays([getQuadraticValue.bind(null, t)], cps));
        },
        cubic: function () {
            var cps = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return makePoint.apply(void 0, __spreadArrays([getCubicValue.bind(null, t)], cps));
        },
    });
}
/**
...
function solveCubicEquation(a, b, c) {
    ...
    var discriminant = roundToDec(q2 * q2 + p3 * p3 * p3, 8);
    // 1 real root
    if (discriminant > 0) {
...
function interpolateCubic(p1, cp1, cp2, p2, p) {
    ...
    var c = p1 / d;
    // @ts-ignore
    return solveCubicEquation(a, b, c).map(function (t) { return roundToDec(t, 4); });
}
// noinspection JSUnusedGlobalSymbols
/**
 ...
 */
export function simpleQuadratic(p1, p2, t, deflection) {
    if (t === void 0) { t = 0.5; }
...
export function elevateDegree(p1, p2) {
    ...
    var newEndPoint = extractPoint(p2);
    var _loop_1 = function (i, newDegree) {
        var coefficient = i / newDegree;
        newEndPoint["cp" + i] = makePoint(function (cpsPrev, cps) {
 ...
 */
export function continueCurve(p1, p2, scaleBy) {
